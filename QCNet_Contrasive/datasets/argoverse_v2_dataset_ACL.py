...
class ArgoverseV2Dataset_ACL(Dataset):
    ...
    def __init__(self,
                 root: str,
                #  root: Union[str, List[str]], ####1013수정
                 split: str,
        ...
        super(ArgoverseV2Dataset_ACL, self).__init__(root=root, transform=transform, pre_transform=None, pre_filter=None)
